...
$jumlahData = count($conn,("SELECT * FROM artikel"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;
$artikel = mysqli_query($conn,"SELECT * FROM artikel LIMIT $awalData, $jumlahDataPerHalaman");
	 ...
	 foreach($artikel as $dt ) : ?>
                    <div class="col-md-4">
						...
						<h5 class="post-title"><?= substr($dt['judul'],0,65);?>...<a href="<?=BASEURLS;?>/home/berita/<?= $dt["artikel_id"];?>"></a></h5></a>	
												<div class="post-body">
								<div class="post-meta">
                                <a class="post-category cat-2" href="<?=BASEURLS;?>/home/kategorii/<?=$dt['kategori']?>"><?=$dt['kategori']?></a>
