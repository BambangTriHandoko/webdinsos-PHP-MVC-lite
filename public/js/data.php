<?php
$koneksi    = mysqli_connect("localhost", "root", "", "dbdinsos");
$penjualan  = mysqli_query($koneksi, "SELECT PMKS FROM visual order by kecamatan asc");
$merk       = mysqli_query($koneksi, "SELECT PSKS FROM visual order by kecamatan asc");
?>
